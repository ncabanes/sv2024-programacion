// Crea una nueva versión de la clase Recuadro, que, en vez
// del método "Inicializar", incluya un constructor para dar valores
// iniciales. 

// Necesitarás también un constructor en RecuadroConSombra…
// y probablemente un constructor vacío (sin parámetros) en Recuadro, para evitar el error de compilación (lo mejoraremos más adelante).
...
class PruebaDeRecuadro
{
    static void Main()
    {
        Recuadro r1 = new Recuadro(3, 4, 5, 3, 'X');
        r1.Dibujar();

        RecuadroConSombra r2 = new RecuadroConSombra(6, 5, 20, 10, 'M');
        r2.Dibujar();

        //Recuadro r3 = new Recuadro();
        //r3.Dibujar();
    }
}
